...
<head>
	...
	<script type="text/javascript" src="${ctx }/static/jquery-mobile/jquery.mobile-1.3.2.min .js"></script>
	<script type="text/javascript" src="${ctx }/static/jq-mobi-plugs/touchTouch.js"></script>
	<script type="text/javascript">
			$('#picture').live("pagecreate",function(){
				$('#thumbs a').touchTouch();
			});
	</script>
</head>
<body>
	<div data-role="page">
		...
		<div data-role="content" class="custom-content">
			...
			<div id="thumbs" data-role="picture" id="picture">
			...
			<div class="ui-grid-b">
				...
				<a data-role="button" href="${module.url}" rel="external" data-prefetch>
